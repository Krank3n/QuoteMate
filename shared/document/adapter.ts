...
function projectShared(s: LegacyDocumentRecord, type: DocumentType): LegacyDocumentRecord {
  return {
    ...
    flatRateInclusions: s.flatRateInclusions,
    flatRateLineLabel: s.flatRateLineLabel,
    pitchId: s.pitchId,
    pitchVariableValues: s.pitchVariableValues,
    pitchRenderedBody: s.pitchRenderedBody,
    labourPresetSnapshot: s.labourPresetSnapshot,
...
export function documentRecordToQuoteRecord(doc: DocumentRecord): LegacyDocumentRecord {
  ...
  return {
    ...
    pitchId: doc.pitchId,
    pitchVariableValues: doc.pitchVariableValues,
    pitchRenderedBody: doc.pitchRenderedBody,
    labourPresetSnapshot: doc.labourPresetSnapshot,
