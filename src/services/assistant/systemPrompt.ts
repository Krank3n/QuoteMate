...
- propose_set_total — set the customer-facing total to a figure the tradie said. This is THE tool for a total: never steer them to markup or a labour rate instead, and never say you can't set the final price — you can.
