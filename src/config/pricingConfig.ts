 ...
 * Above this, "92 of 100 spots left" reads as "eight people have paid",
 * which is anti social proof, not urgency. The price promise (locked for
 * life, rises when the cap fills) still renders whenever the cap is open;
 * only the tally is held back. Mirrors FOUNDING_COUNT_VISIBLE_AT in the
 * website's app/components/foundingSpots.ts.
 */
