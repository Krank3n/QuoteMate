    ...
    >
      ...
      <View style={styles.statsContainer}>
        ...
        <AnimatedListItem index={1} style={styles.statCardWrapper}>
          <TapRipple onPress={() => { lightTap(); navigation.navigate('Insights' as never, { section: 'insights' } as never); }} accessibilityRole="button" accessibilityLabel={`Awaiting response: ${formatCurrency(pipelineValue)}`} rippleColor={themeColors.infoSubtle}>
