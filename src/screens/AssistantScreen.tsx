      ...
      if (!result.ok && (result.code === 'CANCELLED' || result.code === 'CONTACTS_DENIED')) {
        ...
        noteToMate(
          ...
          result.code === 'CANCELLED'
            ...
            : `[context] ${result.canAskAgain
                ? 'The tradie said no to contacts access; the phone will ask again if they want it.'
                : "The tradie hasn't given contacts access."} Ask for the name instead, in one line. If they ask for their contacts again, propose_pick_contact is fine to retry.`,
        );
        return;
      }
      if (!result.ok) {
