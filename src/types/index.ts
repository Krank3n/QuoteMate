...
// Pipeline data shapes (Material, sections, favourites, plans…) live in the
// shared package so the server-side pricing run and the app share one
// definition. Imported for use within this file and re-exported for consumers.
import type {
  Material,
