...
2. splash.png (1242x2436px minimum)
   - Splash screen image
   - Centered on green background (#008542)
...
For now, the app will work without these.
You can use any image as placeholder or create proper branded assets later.
