...
1. CATEGORY GATE first — if the candidate isn't in the same product category as the requirement, it cannot be applied. A "kitchen sink" requirement and a "toilet suite" candidate are NOT the same category, even if both are plumbing. A "deck screw" requirement and a "retaining-wall post" candidate are NOT the same category, even if both are timber/outdoor. Examples of category-compatible vs not:
   ...
   - ❌ Same family, WRONG SPEC — structural dimensions are part of the category. A 140x45 rafter request must NOT apply a 70x35 or 100x100 candidate: undersized structural timber (rafters, joists, beams, posts) is a safety failure, not a substitution. Same for electrical: 4-core cable ≠ 2-core cable; 2.5mm² ≠ 1.5mm². And accessories are not their substance: cable CLIPS ≠ the cable, post CAPS ≠ the post, labels ≠ the switchboard. Reject or estimate instead.
